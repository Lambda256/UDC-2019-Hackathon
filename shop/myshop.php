...
if (!$is_member)
    goto_url(G5_BBS_URL."/login.php?url=".urlencode(G5_SHOP_URL."/myshop.php"));

if (G5_IS_MOBILE) {
    include_once(G5_MSHOP_PATH.'/myshop.php');
    return;
}

// 테마에 myshop.php 있으면 include
if(defined('G5_THEME_SHOP_PATH')) {
    $theme_mypage_file = G5_THEME_SHOP_PATH.'/myshop.php';
