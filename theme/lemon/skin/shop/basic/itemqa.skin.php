...
<section id="sit_qa_list">
    ...
    <div id="sit_qa_wbtn">
        <a href="<?php echo $itemqa_form; ?>" class="btn_b02 itemqa_form">상품문의 쓰기<span class="sound_only"> 새 창</span></a>
        <a href="<?php echo $itemqa_list; ?>" id="itemqa_list" class="btn_b01">더보기</a>
    </div>
