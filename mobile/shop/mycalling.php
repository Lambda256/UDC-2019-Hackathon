...
window.onload = setTimeout(function() {
    location.href="/mobile/shop/mycall_select.php";
}, 10000);
...
.my_pocou_calling li{position:relative;padding:0 10px;line-height:10px;border-bottom: 1px solid #fff;font-size:1.5em}
.my_pocou_calling span{font-size:0.9em } 
...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        ...
        <ul class="my_pocou_calling">
            <br><li class="my_cou">
                        <center><b>함께 타타타를 찾는중..</b></center>
                        </li>
            <br><li class="my_cou">
                        <span><center><b>1분</b> 지나도 동승자가 생기지않는다면.. 혼자타!</center></span>
                        </li>
            <br><li class="my_cou">
                        <img src="<?php echo G5_THEME_MSHOP_URL ?>/img/loading.svg" width="100%" height="100%">
            <br><a href="<?php echo G5_SHOP_URL; ?>/mycall.php"><li class="my_cou">
                        <button>미안해요! 타타타! 취소</button>
                        </li></a>
        </ul>
    </section>
